...
This project transforms a TTGO T-Call ESP32 board into a GSM gateway for TeamSpeak 3. It allows you to make and receive phone calls directly from a TeamSpeak channel. The system is composed of three parts:
...
1.  **Clone the repository:**
    ```bash
    git clone https://github.com/your-username/new_ts_call_bot.git
    cd new_ts_call_bot
    ```
...
| | `channel` | (Not yet implemented) Default channel to join. |
| **Firmware** | | |
