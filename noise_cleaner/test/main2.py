# src https://raw.githubusercontent.com/nautilus-audio/Audio-Signal-Processing-in-Python/refs/heads/master/spectral_subtraction.py
...
run("noise.wav", "audio2clean.wav", 8000)
