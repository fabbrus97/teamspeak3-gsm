# src https://raw.githubusercontent.com/shun60s/spectral-subtraction/refs/heads/master/ss1.py
...
# save as a wav file
scipy.io.wavfile.write(outfile, sr, (y * 32768).astype(np.int16)) # save signed 16-bit WAV format - 32768 = 2^15
